...
- (UIButton *)playBtn {
    if (!_playBtn) {
        ...
        NSBundle *bundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[GKPhotoBrowser class]] pathForResource:@"GKPhotoBrowser" ofType:@"bundle"]];
        [_playBtn setImage:[UIImage imageNamed:@"ic_play" inBundle:bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
        [_playBtn setImage:[UIImage imageNamed:@"ic_pause" inBundle:bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
