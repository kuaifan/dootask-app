...
#if __has_include("GKDefaultCoverView.h")
#import "GKDefaultCoverView.h"
#endif

#if __has_include("GKSDWebImageManager.h")
...
#if __has_include("GKSJPlayerManager.h")
...
#if __has_include("GKAFLivePhotoManager.h")
