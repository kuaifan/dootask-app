...
import app.eeui.framework.extend.module.utilcode.util.CloseUtils;
...
public final class ShellUtils {
    ...
    public static CommandResult execCmd(
        ...
        try {
            ...
            dos.writeBytes("exit" + System.lineSeparator());
            dos.flush();
            ...
            Log.d(TAG, "execCmd: " + e.getMessage());
        } finally {
    ...
    private static String consumeInputStream(final InputStreamReader reader) {
        ...
        try {
            ...
            Log.d(TAG, "consumeInputStream: " + e.getMessage());
        } finally {
